					...
					<div class="contact-border clearfix">
						...
						<div class="attention cleafix">
							<div class="weixin f-l">
								<img
									src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logowx']; ?>"
...
switch ($nav ['nav_type']) {
  ...
  <?php echo html_entity_decode($output['setting_config']['statistics_code'],ENT_QUOTES); ?> <div
		id="footer" class="wrapper">
		<table width="100%" border="0">
			<tr>
				<td width="70%"><table align="center" border="0" cellpadding="0"
						cellspacing="0" width="100%">
						<tbody>
							<tr>
								<td align="middle" height="22"><span>网站系统售前QQ:1187352588</span><a
									href="tencent://message/?uin=1187352588&Site=为你服务&Menu=yes"
									target="blank"><img alt="为你服务" border="0" src="qqonline.gif" /></a><br>
								</td>
							</tr>
						</tbody>
					</table></td>
				<td width="30%"><img src="weixin20151009.jpg" width="100"
					height="125" /></td>
			</tr>
		</table>
	</div>
...
<link
	href="<?php echo RESOURCE_SITE_URL;?>/js/perfect-scrollbar.min.css"
	rel="stylesheet" type="text/css">
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/qtip/jquery.qtip.min.js"></script>
<link href="<?php echo RESOURCE_SITE_URL;?>/js/qtip/jquery.qtip.min.css"
	rel="stylesheet" type="text/css">
<!-- 对比 -->
